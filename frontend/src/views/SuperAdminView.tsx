      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-xs overflow-hidden">
        <div className="p-4 border-b border-slate-200 bg-slate-50 flex items-center justify-between">
          <h2 className="font-bold text-slate-800 text-sm flex items-center gap-2">
            ...
            سجل الصيدليات المشتركة ({tenants.length})
          </h2>
          ...
          <table className="w-full text-right text-xs">
            <thead className="bg-slate-100 text-slate-700 font-bold border-b border-slate-200">
              <tr>
                ...
                <th className="p-3 text-center">إجراءات الحسابات والإدارة</th>
              </tr>
            </thead>
              ...
              {tenants.map((t) => (
                <tr key={t.id} className="hover:bg-slate-50/70 transition-colors">
                  ...
                  <td className="p-3 text-slate-600 font-medium">
                    {new Date(t.subscriptionEndsAt).toLocaleDateString('ar-IQ')}
                  </td>
                  <td className="p-3 text-center">
                    <div className="flex items-center justify-center gap-1.5">
                      ...
                      <button
                        ...
                        className="px-2.5 py-1 bg-amber-50 hover:bg-amber-100 text-amber-800 rounded-md font-bold text-xs flex items-center gap-1 cursor-pointer transition-colors border border-amber-200"
                        title="عرض المستخدمين واسترجاع/تغيير كلمات المرور"
                      >
                      ...
                      <button
                        ...
                        className="px-2.5 py-1 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-md font-bold text-xs flex items-center gap-1 cursor-pointer transition-colors"
                      ...
                      <button
                        ...
                        className="px-2.5 py-1 bg-emerald-50 hover:bg-emerald-100 text-emerald-700 rounded-md font-bold text-xs cursor-pointer transition-colors"
                      >
                        + تمديد سنة
                      </button>
                      ...
                      >
                        {t.subscriptionStatus === 'ACTIVE' ? 'إيقاف' : 'تفعيل'}
                      </button>

                      {/* Delete Button */}
                      <button
                        onClick={() => setDeleteConfirmTenant(t)}
                        className="p-1.5 bg-rose-50 hover:bg-rose-100 text-rose-600 hover:text-rose-800 rounded-md transition-colors cursor-pointer"
